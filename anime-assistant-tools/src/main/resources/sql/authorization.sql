...
CREATE TABLE "public"."authorization" (
  "user_id" int8 NOT NULL nextval('auth_seq'::regclass),
...
-- ----------------------------
ALTER TABLE "public"."authorization" ADD CONSTRAINT "authorization_pkey" PRIMARY KEY ("user_id");
